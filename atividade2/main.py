...
def menu_eleitor():
    ...
    while op not in (1, 2, 3):
        ...
        return op
def menu_candidatos():
    print("Urna Pronta para o seu voto")
    print("Use o teclado numerico para votar")
    op = 0
    while op not in ['Sim' , 'Nao']:
        op = str(input('Digite uma das Opcoes[Sim ou Nao]')):
        if op == 'Sim':
             candidato.LIstar.Candidato()
        elif op == 'Nao':
             candidato.Acabou sua açao()
